...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                \App\GraphQL\Queries\AgentsQuery::class,
                \App\GraphQL\Queries\AgentQuery::class,
                \App\GraphQL\Queries\UserAgentsQuery::class,
                \App\GraphQL\Queries\MeQuery::class,
                \App\GraphQL\Queries\ConfigQuery::class,
                \App\GraphQL\Queries\TransactionsQuery::class,
                \App\GraphQL\Queries\TransactionQuery::class,
                \App\GraphQL\Queries\StatisticsQuery::class,
                \App\GraphQL\Queries\SummaryQuery::class,
                \App\GraphQL\Queries\DailyAdvancesQuery::class,
                \App\GraphQL\Queries\EodSettlementQuery::class,
                \App\GraphQL\Queries\SettlementHistoryQuery::class,
                \App\GraphQL\Queries\QueueStatusQuery::class,
                \App\GraphQL\Queries\CloneStatusQuery::class,
                \App\GraphQL\Queries\MomoCheckStatusQuery::class,
            ],
            'mutation' => [
                \App\GraphQL\Mutations\LogoutMutation::class,
                \App\GraphQL\Mutations\CreateAgentMutation::class,
                \App\GraphQL\Mutations\UpdateAgentMutation::class,
                \App\GraphQL\Mutations\DeleteAgentMutation::class,
                \App\GraphQL\Mutations\CreateTransactionMutation::class,
                \App\GraphQL\Mutations\UpdateTransactionStatusMutation::class,
                \App\GraphQL\Mutations\SettleDailyAdvancesMutation::class,
                \App\GraphQL\Mutations\SaveEodSettlementMutation::class,
                \App\GraphQL\Mutations\GenerateMoMoQRMutation::class,
                \App\GraphQL\Mutations\ScanCCCDMutation::class,
                \App\GraphQL\Mutations\QueueDispatchMutation::class,
                \App\GraphQL\Mutations\TriggerCloneMutation::class,
            ],
            // The types only available in this schema
            'types' => [
                \App\GraphQL\Types\AgentType::class,
                \App\GraphQL\Types\RequestAckType::class,
                \App\GraphQL\Types\UserType::class,
                \App\GraphQL\Types\TransactionType::class,
                \App\GraphQL\Types\TransactionPaginatedType::class,
                \App\GraphQL\Types\ConfigType::class,
                \App\GraphQL\Types\StatisticsType::class,
                \App\GraphQL\Types\RecentStatsItemType::class,
                \App\GraphQL\Types\SummaryItemType::class,
                \App\GraphQL\Types\JsonResultType::class,
                \App\GraphQL\Types\SettlementRecordType::class,
                \App\GraphQL\Types\SettlementHistoryPaginatedType::class,
                \App\GraphQL\Types\QueueStatusType::class,
